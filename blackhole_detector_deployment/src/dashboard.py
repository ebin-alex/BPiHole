...
class Dashboard:
                ...
                if search_term:
                    filtered_detections = [
                        ...
                        if search_term in d['source_ip'].lower() or 
                           search_term in d['destination_ip'].lower()
                    ]
    ...
    def add_detection(self, detection):
        ...
        try:
            self.logger.debug(f"Added detection: {json.dumps(detection, cls=NumpyEncoder)}")
    ...
    def _run_server(self):
        ...
        try:
            ...
            self.logger.error(f"Error running Flask server: {str(e)}")
